...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    // Check if a gallery avatar was posted from avatar_builder.php (AJAX)
    elseif (isset($_POST['gallery_avatar']) && !empty($_POST['gallery_avatar'])) {
        require_once "includes/avatar_gallery_data.php";
        $chosen = basename($_POST['gallery_avatar']); // strip any path component defensively
        if (in_array($chosen, avatar_gallery_all_files(), true)) {
            $avatar_file = "gallery/" . $chosen;
        }
