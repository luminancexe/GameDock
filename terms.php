...
<div class="container mt-4">
    <div class="policy-container">
        ...
        <p class="policy-text">
            ...
            site, you agree that you have read, understood, and agree to be bound by all of these Terms and
        ...
        <p class="policy-text">
            ...
            are not valid commercial licenses. No goods, services, or currency exchanged through this platform
            carry real-world monetary or legal value, and GameDock should not be relied upon as a functioning
        ...
        <p class="policy-text">
            ...
            registering and to keep that information up to date. You must immediately notify us of any
            unauthorized use of your account or any other breach of security. We are not liable for any loss or
        ...
        <ul class="policy-list">
            ...
            <li>Attempt to gain unauthorized access to other users' accounts or to platform systems.</li>
        ...
        <p class="policy-text">
            ...
            forbidden on this platform. We reserve the right to review, reject, remove, or suspend any listing
        ...
        <p class="policy-text">
            ...
            order. Rental periods begin upon activation and are not paused, extended, or transferable once
            started. Prices displayed in currencies other than USD are indicative conversions for display purposes
        ...
        <p class="policy-text">
            ...
            publisher names, cover art, and related trademarks referenced on the platform remain the property of
        ...
        <p class="policy-text">
            ...
            survive termination (including ownership provisions, warranty disclaimers, and limitations of
        ...
        <p class="policy-text">
            ...
            an academic project, GameDock makes no guarantee of uptime, data persistence, or continued
