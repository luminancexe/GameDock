...
<div class="container mt-4 form-container" style="max-width: 50rem;">
    ...
    <div class="faq-item" style="margin-bottom: 1.5625rem;">
        ...
        <p style="color: #D1D5DB;">If you have any further questions, run into an issue with an order, or need help with your account, please visit our <a href="contact.php" style="color: var(--accent); font-weight: bold;">Contact page</a> to send us a direct message. Including your order number or account email when relevant helps us resolve your request faster.</p>
    </div>
