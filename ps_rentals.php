            ...
            <?php foreach ($ps_games as $game): ?>
                <div class="game-card">
                    ...
                    <div class="game-card-content">
                        ...
                        <p class="price">$<?php echo htmlspecialchars($game['rent_price']); ?> / day</p>
                        ...
                        <?php if(isset($_SESSION['user_id'])): ?>
                            ...
                            <?php if(in_array($game['game_id'], $active_rentals)): ?>
                                <div style="background-color: var(--success); color: white; padding: 10px; border-radius: 5px; text-align: center; margin-bottom: 10px; font-weight: bold;">
                        ...
                        <?php if ($game['stock'] <= 0): ?>
                            <button class="btn" style="background-color: #9CA3AF; color: white; cursor: not-allowed; display: block; width: 100%;" disabled>Out of Stock (Rented Out)</button>
                        <?php else: ?>
